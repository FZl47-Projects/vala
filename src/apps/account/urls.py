...
urlpatterns = [
    ...
    path('dashboard/user/delete/<int:user_id>', views.DashboardDeleteUser.as_view(), name='user__delete'),
    path('dashboard/user/detail/<int:user_id>', views.DashboardUserDetail.as_view(), name='user__detail'),
    path('dashboard/user/update/<int:user_id>', views.DashboardUserUpdate.as_view(), name='user__update'),
