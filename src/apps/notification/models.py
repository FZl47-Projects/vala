...
class Notification(BaseModel):
    ...
    title = models.CharField(_('Notif title'), max_length=150)
    description = models.TextField(_('Notif description'), null=True, blank=True)

    # Attach content
    image = models.ImageField(upload_to='images/notifications/', null=True, blank=True, max_length=400)
    ...
    is_showing = models.BooleanField(default=True)  # Showing user or not
